  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "inset-x-2 inset-y-2 p-4 rounded-lg overflow-y-auto",
        // Desktop styles
        "sm:left-[50%] sm:top-[50%] sm:max-w-lg sm:translate-x-[-50%] sm:translate-y-[-50%] sm:max-h-[calc(100vh-4rem)] sm:p-6 sm:rounded-lg",
        // Animations
...
const DialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-1.5 text-left pb-2 sm:pb-4",
      className
    )}
    {...props}
  />
